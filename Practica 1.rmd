...
INFERENCIA: Según este análisis en base a lo que ya venía sucediendo con la red telefónica suponemos o predecimos que los próximos datos enviados desde la red seguirán con el mismo problema.
...
1/ El conjunto de datos con los datos de las conexiones TCP originadas des de los equipos corporativos

2/ El conjunto de datos con los servicios legítimos que como parte de nuestro negocio prestamos a clientes.
